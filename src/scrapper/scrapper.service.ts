...
export class ScrapperService {
    async getDataViaPuppeteer(location: string = '') {
        ...
        const results = await page.evaluate(() => {
            ...
            document.querySelectorAll('.ListingsListstyle__ListingListItemWrapper-bmHwPm').forEach(z => {
                let tempImgList = [];

                z.querySelectorAll('.ListingImageCarouselstyle__CarouselWrapper-dtbMQB.jibwWZ.Premium picture').forEach(x => {
                ...
                const data = {
                    ...
                    address: z.querySelector('.detail-property > div > div.PremiumCardstyle__AddressWrapper-ldsjqp.gRJjrp')?.textContent,
                    descriptionItem: z.querySelector('.detail-property .attributes-description > p')?.textContent,
                    ...
                    postedDate: z.querySelector('.ListingHeadingstyle__HeadingCreationDate-hVckGQ')?.textContent,
                    imgList: tempImgList
                }
